...
function update_map($config_folder){
	if(isset($_POST['update_map'])){
		$new_values = array(
			...
			'use_mapboxgljs' => $_POST['use_mapboxgljs'],
			'mapbox_style_url' => $_POST['mapbox_style_url'],
			'mapbox_mobile_style_url' => $_POST['mapbox_mobile_style_url'],
			'mapbox_key' => $_POST['mapbox_key'],
			'use_google' => $_POST['use_google'],
			'google_api_key' => $_POST['google_api_key'],
			'google_extra_layer' => $_POST['google_extra_layer'],
			'map_url' => $_POST['map_url'],
			'mobile_map_url' => $_POST['mobile_map_url'],
...
function update_openalpr(){
	if(isset($_POST['update_openalpr'])){		
		if (count($_POST['openalpr_countries']) > 0){
			...
			$new_values = array(
				'openalpr_api_key' => $_POST['openalpr_api_key'],
				'openalpr_countries' => $_POST['openalpr_countries']
			);
			//error_log($new_country_array);
		}
		else {
